...
class MysteryFunctionLabeled(Scene):
    ...
    def construct(self):
        ...
        omega_group = build_animated_graph(MathTex("\\omega (t)").scale(0.75),
                                           omega_func,
                                           tracker,
                                           x_range=[0, AXIS_LENGTH, 1],
                                           x_length=4,
...
class NoiseFunctionLabeled(Scene):
...
class GoodFunctionExplanationLabeled(Scene):
